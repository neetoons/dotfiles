{ inputs, config, pkgs, lib, ... }:
{
  ...
  programs.niri.settings = {
   ...
   outputs."eDP-1" = {
    ...
    spawn-at-startup = [
      { command = ["sh" "-c" "waypaper --restore" ]; }
      { command = ["eww" "-c" "${config.xdg.configHome}/eww" "open-many" "bar" ]; }
      { command = ["rclone" "mount" "nit:" "${config.xdg.configHome}/GoogleDrive" ]; }
      { command = ["sh" "-c" "wl-paste" "--type" "text" "--watch" "cliphist" "store" ]; }
      { command = ["sh" "-c" "pulseeffects" ]; }
    ];
...
binds = {
      ...
      "Mod+D".action.spawn-sh =  ["xdg-open /home/nit/Downloads"];
      ...
      "Mod+Shift+KP_End".action.spawn-sh = [ "mpv '/home/nit/Downloads/5. Audio/fah.ogg'" ];
      "Mod+Shift+KP_Down".action.spawn-sh = [ "mpv '/home/nit/Downloads/5. Audio/stfu.mp3'" ];
      "Mod+Shift+KP_Next".action.spawn-sh = [ "mpv '/home/nit/Downloads/5. Audio/efn.ogg'" ];
      "Mod+Shift+KP_Left".action.spawn-sh = [ "mpv '/home/nit/Downloads/5. Audio/toma mamaguevo.mp3'" ];
      #Mod+Shift+KP_End    {spawn-sh-sh "mpv '/home/nit/Downloads/5. Audio/fah.ogg'";}
      #Mod+Shift+KP_Down   {spawn-sh-sh "mpv '/home/nit/Downloads/5. Audio/stfu.mp3'";}
      #Mod+Shift+KP_Next   {spawn-sh-sh "mpv '/home/nit/Downloads/5. Audio/efn.ogg'";}
      #Mod+Shift+KP_Left   {spawn-sh-sh "mpv '/home/nit/Downloads/5. Audio/toma mamaguevo.mp3'";}
      ...
      #"Mod+wheelscrollup".action.focus-column-left = { cooldown-ms=200;};
      "Mod+wheelscrollup".action.focus-column-left = { };
      #"Mod+wheelscrolldown".action.focus-column-right = {cooldown-ms=200;};
      "Mod+wheelscrolldown".action.focus-column-right = {};

      #"Mod+Shift+wheelscrollup".action.focus-column-right = {cooldown-ms=150;};
      ...
      "Mod+Print".action.spawn-sh = [ "mkdir -p ~/Pictures/screenshots && grim -t png -g \"$(slurp)\" - | satty --filename - -o ~/Pictures/screenshots/Screenshot_$(date +%Y-%m-%d_%H-%M-%S).png" ];
      "Mod+Ctrl+Print".action.spawn-sh = [ "mkdir -p ~/Pictures/screenshots && grim -g \"0,0 1440x900\" - | tee ~/Pictures/screenshots/Screenshot_$(date +%Y-%m-%d_%H-%M-%S).png | wl-copy" ];
